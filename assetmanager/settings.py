...
Secure Asset Management App with Persistent Login
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'assetmanager'),
...
# ============================================
# Session age: 30 days (in seconds)
SESSION_COOKIE_AGE = 60 * 60 * 24 * 30  # 30 days

# Don't expire session when browser closes
SESSION_EXPIRE_AT_BROWSER_CLOSE = False

# Save session on every request to refresh expiry
...
ALLOWED_DOCUMENT_EXTENSIONS = ['.pdf', '.jpg', '.jpeg', '.png', '.gif', '.doc', '.docx', '.xls', '.xlsx']
